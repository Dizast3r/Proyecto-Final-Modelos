"""
Patron de Diseno State (UI):
Maneja los diferentes estados de la interfaz de usuario del juego (Menu Principal,
Jugando, Nivel Completado, Game Over). Permite transiciones fluidas y encapsula
la logica de renderizado y entrada para cada estado.
"""
...
class GameState(Enum):
    """
    Enumeracion de estados posibles del juego.
    Define el contexto en el que se encuentra la aplicacion.
    """
    MAIN_MENU = "main_menu"
    PLAYING = "playing"
...
class Button:
    """Componente de UI reutilizable para interacción del usuario."""
    ...
    def draw(self, screen: pygame.Surface, font: pygame.font.Font):
        """Renderiza el boton con efectos visuales de estado."""
    ...
    def is_clicked(self, mouse_pos: tuple, mouse_clicked: bool) -> bool:
        """Determina si el boton ha sido activado."""
        return self.rect.collidepoint(mouse_pos) and mouse_clicked


class MenuManager:
    """
    Gestor de Menus (Contexto de UI):
    Administra la navegacion entre pantallas y la renderizacion de los diferentes
    estados del menu. Actua como controlador de la interfaz grafica.
    """
    ...
    def __init__(self, screen: pygame.Surface):
        ...
        # Inicializacion de recursos graficos (Fuentes)
        ...
        # Definicion de Callbacks (Hooks para logica externa)
    ...
    def _create_buttons(self):
        """Inicializa la configuracion de botones para todas las pantallas."""
        ...
        # Configuracion NIVEL COMPLETADO
        ...
        # Configuracion JUEGO COMPLETADO
    ...
    def draw_background_overlay(self, alpha: int = 180):
        """Renderiza una capa oscura semitransparente para modales."""
    ...
    def draw_title(self, text: str, y: int, color: tuple = (255, 215, 0)):
        """Helper para renderizar titulos centrados con sombra."""
    ...
    def draw_subtitle(self, text: str, y: int, color: tuple = (255, 255, 255)):
        """Helper para renderizar subtitulos centrados."""
    ...
    # ========================================================================
    # LOGICA DE RENDERIZADO POR ESTADO
    # ========================================================================
    
    def draw_main_menu(self):
        """Renderiza la pantalla del Menu Principal."""
        # Fondo degradado
        ...
        subtitle_text = self.text_font.render(
            "Proyecto Final - Patrones de Diseno", 
            True, (200, 200, 200)
        )
    ...
    def handle_main_menu_click(self, mouse_pos: tuple, mouse_clicked: bool):
        """Procesa interacciones en el Menu Principal."""
    ...
    def handle_level_complete_click(self, mouse_pos: tuple, mouse_clicked: bool):
        """Procesa interacciones en Nivel Completado."""
    ...
    def draw_game_complete_menu(self):
        """Renderiza la pantalla de Juego Completado (Victoria Final)."""
        self.draw_background_overlay(200)
    ...
    def handle_game_complete_click(self, mouse_pos: tuple, mouse_clicked: bool):
        """Procesa interacciones en Juego Completado."""
    ...
    def handle_game_over_click(self, mouse_pos: tuple, mouse_clicked: bool):
        """Procesa interacciones en Game Over."""
    ...
    def draw_current_menu(self, world_name: str = ""):
        """Metodo fachada para renderizar el menu correspondiente al estado actual."""
    ...
    def handle_click(self, mouse_pos: tuple, mouse_clicked: bool):
        """Metodo fachada para delegar el manejo de clicks al estado actual."""
        if self.current_state == GameState.MAIN_MENU:
